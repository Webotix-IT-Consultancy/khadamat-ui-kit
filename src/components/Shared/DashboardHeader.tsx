...
interface DashboardHeaderProps {
    ...
    /**
     * KP1-I177 — the number of UNREAD notifications, and only ever a number the caller was
     * actually told by the server.
     *
     * It used to default to `32`: a figure lifted off a mockup, fetched from nowhere and
     * decremented by nothing, which NEITHER portal has ever passed. Every user of both
     * portals therefore read the same invented "32" on the bell, for the life of every
     * session. The default is gone and the badge renders only for a real, positive count, so
     * the bell stays bare until there is an unread count to show.
     */
        ...
        <div className="flex justify-between items-center w-full h-full">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                ...
                >
                    ...
                    {/* KP1-I177: no count, no badge — see the prop's note. A zero is not a
                        badge either: an empty red dot says "something is waiting" when
                        nothing is. */}
